...
Se define relevancia como importacia o cualidad de destacable. A lo largo de los años, se han propuesto diferentes aproximaciones matemáticas que determinan la relevancia de un texto, concepto o término. Debido a su simplicidad, eficacia y bajo coste computacional, el algoritmo emph{TF-IDF}(Term frequency - Inverse Document Frequency) \cite{ramos2003using} ha sido el más utilizado por la comunidad científica y, por esos mismos motivos es empleado en este trabajo. Parte de la asunción de que cuanto más sea repetido un término o concepto dentro de un documento, más relevante es (Term Frequency) dentro de ese texto. No obstante, si ese término es muy común en un conjunto de textos, su relevancia baja (Inverse Documento Frequency).
 A pesar de sus virtudes, sólo tener en cuenta la parte frecuencial de los términos le resta potencial, de ahí que la comunidad científica haya propuesto numerosas modificaciones \cite{wang2019feature} con resultados desiguales para resolver sus limitaciones, como el TF-IGM \cite{chen2016turning}
